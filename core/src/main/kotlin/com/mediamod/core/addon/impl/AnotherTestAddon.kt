...
class AnotherTestAddon : MediaModAddon {
    /**
     ...
     */
    override val identifier = "another-test-addon"
     ...
     */
    override val name: String = "AnotherTestAddon"

    /**
     * A logger instance for this class, used for logging debug information
     */
    private val logger = LogManager.getLogger("AnotherTestAddon")
