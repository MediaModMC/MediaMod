...
public class BaseMod {
    ...
    public static boolean init() {
        try {
            ...
            data.addProperty("accessToken", Minecraft.getMinecraft().getSession().getToken());
            data.addProperty("selectedProfile", Minecraft.getMinecraft().getSession().getPlayerID());
            ...
            // Create a conncetion
            URL url = new URL(ENDPOINT + "/mediamod/analytics/register/" + Minecraft.getMinecraft().getSession().getUsername() + "/" + Metadata.MODID + "/" + Metadata.VERSION);
